...
<head>
    ...
    <title>Kelola Edukasi - SPPG Kokrosono</title>
    <!-- CDN Tailwind CSS -->
    <script src="https://cdn.tailwindcss.com"></script>
</head>
<body class="bg-gray-100 font-sans antialiased flex h-screen overflow-hidden">

    <!-- MODAL FORM (Tambah & Edit Konten Edukasi MySQL) -->
    <div id="edukasi-modal" class="fixed inset-0 bg-black/60 backdrop-blur-xs flex items-center justify-center hidden z-50 p-4 transition-all duration-300">
        <div class="bg-white rounded-2xl border border-gray-100 w-full max-w-lg p-6 shadow-xl transform scale-95 transition-all duration-300" id="modal-container">
            <div class="flex justify-between items-center mb-4">
                <h3 id="modal-title" class="text-lg font-bold text-gray-900">Tambah Konten Edukasi</h3>
    ...
    <div id="delete-modal" class="fixed inset-0 bg-black/60 backdrop-blur-xs flex items-center justify-center hidden z-50 p-4 transition-all duration-300">
        <div class="bg-white rounded-2xl border border-gray-100 w-full max-w-sm p-6 shadow-xl transform scale-95 transition-all duration-300" id="delete-modal-container">
            <div class="flex flex-col items-center text-center">
                ...
                <h3 class="text-lg font-bold text-gray-900 mb-1">Hapus Konten Edukasi?</h3>
                <p class="text-sm text-gray-500 mb-6">Tindakan ini tidak dapat dibatalkan. Konten <strong id="delete-target-name" class="text-gray-950"></strong> akan dihapus permanen dari MySQL.</p>
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <header class="bg-white shadow-xs h-16 flex items-center justify-between px-6 border-b border-gray-200 shrink-0">
            <h1 class="text-lg font-bold text-gray-900">Kelola Konten Edukasi</h1>
        ...
        <main class="flex-1 overflow-y-auto p-6 space-y-6">
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div class="relative w-full md:max-w-xs">
                    ...
                    <input type="text" id="search-input" oninput="searchEdukasi()" placeholder="Cari judul artikel..." class="w-full bg-white border border-gray-200 rounded-xl py-2.5 pl-10 pr-4 text-sm focus:ring-2 focus:ring-green-500 focus:border-green-500 outline-none transition shadow-xs">
                </div>
            ...
            <div class="bg-white rounded-xl shadow-xs border border-gray-200 overflow-hidden">
                <div class="p-4 border-b border-gray-200 bg-gray-50 font-bold text-gray-700 text-sm flex items-center justify-between">
                    <div class="flex items-center gap-2">
                        ...
                        <span>Artikel & Video Edukasi Publik</span>
                    </div>
                    <span class="text-xs bg-gray-200 text-gray-700 px-2.5 py-1 rounded-md" id="edukasi-count">Total: {{ $allEdukasi->count() }}</span>
                </div>
